...
/* Internal reference voltage (STM32F103C8T6 datasheet стр. 40 п. 5.3.4,
   Таблица 12 "Embedded internal reference voltage") */
#define VREFINT 1200.0f //Типичное 1.200 V (Умножил на 1000 для более точных расчетов)
...
void TIM4_IRQHandler(void)
{
  ...
  /* USER CODE BEGIN TIM4_IRQn 1 */
	HAL_ADC_Start_DMA(&hadc1, (uint32_t*)ADC_RAW_Data, 2);
